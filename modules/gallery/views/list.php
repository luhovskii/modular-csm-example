...
<head>
  ...
  <style>
    ...
    .card{background:#fff;border-radius:8px;overflow:hidden;box-shadow:0 6px 18px rgba(12,18,30,.06)}
    .card img{width:100%;height:180px;object-fit:cover;display:block}
    .caption{padding:8px 10px;font-size:14px}
    a.view{display:block;text-decoration:none;color:inherit}
  </style>
</head>
<body>
  <div class="wrap">
